    ...
    public function get()
{
    ...
    for ($page = $limits[0]; $page <= $limits[1]; $page++) {
        ...
        if ($page == $this->current_page) {
            $links .= '<li class="pagination__Li"><span class="pagination__Span">' . $page . '</span></li>';
        } else {
    ...
    private function generateHtml($page, $text = null)
{
   ...
   // $currentURI = preg_replace('~/page=[0-9]+~', '', $currentURI);
    ...
    return
        '<li class="pagination__Li"><a class="pagination__Link" href="' . $currentURI . $this->index . $page . '">' . $text . '</a></li>';
}
    /**
